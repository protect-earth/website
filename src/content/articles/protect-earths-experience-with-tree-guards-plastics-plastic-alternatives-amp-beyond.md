...
[Nexgen](https://nexgen-ts.com/) has been promising to introduce wool-based tree guards, and the wait has been filled with anticipation on Protect Earth's part. Again, this plastic alternative guard will be more expensive than plastics, but material costs can't be the only qualifying factor when considering guards.
...
If, like Protect Earth, you want to see less plastic being used to rehabilitate the UK and biodiversity, please donate to our "[General Donations](https://www.protect.earth/donate)" pot. We can allocate donations towards testing more environmentally friendly options and moving towards more regular use of those that work, even if regular government grants don't cover all the costs.
