...
CLTs are typically used to provide affordable homes, community gardens, civic buildings, pubs, shops, shared workspaces, energy schemes, and _conservation landscapes_. Unlike traditional land ownership, CLTs are locally driven, democratically accountable, and open to membership for all residents and workers in the defined area. Members elect a volunteer board to manage the trust's day-to-day operations.
